<<<<<<< Updated upstream:v-conf/src/main/java/com/example/models/InvoiceHeader.java
...
>>>>>>> Stashed changes:v-config/src/main/java/com/example/models/InvoiceHeader.java
}